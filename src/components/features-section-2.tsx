      ...
      <div className="container flex flex-col gap-20 lg:flex-row lg:items-end">
        <div className="flex flex-1 flex-col gap-7">
          <div className="flex flex-col gap-2">
            <span className="text-left font-heading font-bold text-primary">A Powerful Asset</span>
          ...
          <p className="flex-1 text-lg text-muted-foreground">
            Your intern works hard to create organic engagement with your ecosystem and trending
            topics!
          </p>
