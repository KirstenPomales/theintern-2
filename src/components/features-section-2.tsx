import { Zap, Brain, LayoutDashboard, ChartBar } from "lucide-react";
      ...
      <div className="container flex gap-20 flex-col lg:flex-row lg:items-end">
        <div className="flex-1 flex flex-col gap-7">
          <div className="flex flex-col gap-2">
            <span className="font-bold text-primary text-left font-heading">
              DataPulse Analytics
            </span>
            <h1 className="font-heading font-bold sm:text-5xl text-3xl tracking-tight text-balance font-semibold">
